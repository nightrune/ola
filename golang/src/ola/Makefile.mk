...
$(SRCDIR)/ola_proto/Ola.pb.go: golang/src/ola/Makefile.mk common/protocol/Ola.proto
	$(PROTOC) --go_out golang/src/ola/ola_proto --proto_path $(srcdir)/common/protocol $(srcdir)/common/protocol/Ola.proto

$(SRCDIR)/ola_rpc/Rpc.pb.go: golang/src/ola/Makefile.mk common/rpc/Rpc.proto
